...
class ParaCrawl:
    ...
    def do_crawling(self):
        ...
        print("Time taken for {} thread(s) to download required images is {}".format(self.n_threads, end-st))
        print('End Program')
    ...
    def imbalance_check(self):
        ...
        if len(dict_too_small) >= 1:
            ...
            print('Recommendation to remove these directories and re-download for that keyword.')
